...
항해 Lite 백엔드 코스의 e-commerce 서비스 프로젝트로, 상품 주문 및 결제 시스템을 구현하였습니다. 본 프로젝트는 Clean Architecture와 Domain-Driven Design(DDD) 원칙을 적용하여 설계되었으며, 실제 운영 환경에서 발생할 수 있는 동시성 문제를 해결하는 것을 목표로 합니다.
