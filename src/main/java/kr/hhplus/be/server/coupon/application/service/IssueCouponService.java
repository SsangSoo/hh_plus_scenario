...
public class IssueCouponService implements IssueCouponUseCase {
    ...
    @Override
    @Transactional
    public void issue(IssueCouponServiceRequest serviceRequest) {
        ...
        Boolean isCouponIssue = redisUtil.setIfAbsent(
                "coupon:" + serviceRequest.couponId() + ":member:" + serviceRequest.memberId(),
                "1",
        ...
        eventPublisher.publishEvent(new CouponIssueEvent(coupon.getId(), member.getId()));
    }
