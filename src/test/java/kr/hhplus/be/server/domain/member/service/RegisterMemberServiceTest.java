...
class RegisterMemberServiceTest {
    ...
    RegisterMemberService memberService;


    @BeforeEach
    void setUp() {
        memberService = new RegisterMemberService(memberRepository, pointRepository);
    }
    ...
    void whenRegisterMemberThenPointIsZero() {
        ...
        MemberJpaEntity member = MemberJpaEntity.register(request);
    ...
    void retrieveTest() {
        ...
        // when : 회원 조회
        MemberResult response = memberService.retrieve(memberId);
